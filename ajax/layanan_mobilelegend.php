...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) AND strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	if (isset($_POST['operator'])) {
		...
		$cek_layanan = $conn->query("SELECT * FROM layanan_pulsa WHERE operator = '$post_operator' AND tipe = 'Games' AND provider = 'ARIEPULSA' AND status = 'Normal' ORDER BY harga ASC");
		?>
